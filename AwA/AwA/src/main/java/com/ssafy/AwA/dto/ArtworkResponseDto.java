...
public class ArtworkResponseDto {
    ...
    public ArtworkResponseDto(Long artwork_id, LocalDateTime createdDate, String sell_user, String title, int price, List<AttachmentRequestDto> attachmentRequestDtoList,
